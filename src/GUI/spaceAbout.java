 ...
 * @author UserSoffti
 */
public class spaceAbout extends javax.swing.JFrame {

    /**
     * Creates new form spaceAbout
     */
    public spaceAbout() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 510));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(spaceAbout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new spaceAbout().setVisible(true);
            }
        });
    }
