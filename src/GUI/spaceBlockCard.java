 ...
 * @author UserSoffti
 */
public class spaceBlockCard extends javax.swing.JFrame {

    /**
     * Creates new form spaceBlockCard
     */
    public spaceBlockCard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("o bloqueio do cartão");
        jpDashboard.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, -1, -1));
        ...
        jpDashboard.add(jpSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 360, 100));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel5.setText("Digite sua senha para realizar");
    ...
    private void lblContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblContinuarMouseClicked
        ...
        sBlockCard.dispatchEvent(new WindowEvent(sBlockCard, WindowEvent.WINDOW_CLOSING));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(spaceBlockCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new spaceBlockCard().setVisible(true);
            }
        });
    }
