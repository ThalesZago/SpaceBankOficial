 ...
 * @author UserSoffti
 */
public class spaceConfirmTransfer extends javax.swing.JFrame {

    /**
     * Creates new form spaceConfirmTransfer
     */
    public spaceConfirmTransfer() {
        initComponents();
    }
    ...
    private void btnConfirmarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConfirmarMouseClicked
        ...
        sConTransfer.dispatchEvent(new WindowEvent(sConTransfer, WindowEvent.WINDOW_CLOSING));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(spaceConfirmTransfer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new spaceConfirmTransfer().setVisible(true);
            }
        });
    }
