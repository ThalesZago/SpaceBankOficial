 ...
 * @author UserSoffti
 */
public class spaceConfirmPayment extends javax.swing.JFrame {

    /**
     * Creates new form spaceConfirmPayment
     */
    public spaceConfirmPayment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Digite sua senha para confirmar");
        jpDashboard.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, -1, -1));
        ...
        jpDashboard.add(jpSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 360, 100));
    ...
    private void btnConfirmarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConfirmarMouseClicked
        ...
        sConPay.dispatchEvent(new WindowEvent(sConPay, WindowEvent.WINDOW_CLOSING));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(spaceConfirmPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new spaceConfirmPayment().setVisible(true);
            }
        });
    }
